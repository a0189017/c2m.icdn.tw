(function ($) {
    ...
    $.fn.twaddress = function () {
        this.each(function () {
            ...
            var $inputbox = $(this);
            var $twaddrs = $('<div class="address-group"></div>');
            var $twcity = $('<select class="location city"></select>');
            var $twmore = $('<input type="text" class="address"></input>');
            ...
            $twcity.change(function () {
                var $new_twdist = $('<select class="location dist"></select>');
